...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
  ...
  const inputClasses = "w-full bg-slate-50 border-b-2 border-slate-200 px-4 py-3 outline-none transition-all duration-300 focus:border-yellow-400 focus:bg-white placeholder-slate-400";
  const labelClasses = "block text-sm font-bold text-slate-700 mb-1 uppercase tracking-wider";

  return (
    <div className="min-h-screen bg-white font-sans text-slate-800 selection:bg-yellow-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            <div className="relative mb-12">
               ...
               />
               <h1 className="text-6xl font-serif font-bold text-slate-900 mb-6 relative z-10">
                 Let's Start a <br/>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4 group cursor-pointer">
                <div className="w-12 h-12 bg-slate-50 flex items-center justify-center rounded-full text-slate-400 group-hover:bg-yellow-400 group-hover:text-slate-900 transition-all duration-300 shadow-sm group-hover:shadow-lg group-hover:scale-110">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                </div>
                <div>
                  <h3 className="font-bold text-slate-900 mb-1">Email Me</h3>
                  <a href="mailto:hello@madelyntorff.com" className="text-slate-500 group-hover:text-yellow-600 transition-colors">mehrad.ata@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-slate-500 group-hover:text-yellow-600 transition-colors">Remote / Oakville, On, Ca</p>
                </div>
              </div>
          ...
          <motion.div 
            ...
            className="bg-white rounded-[2.5rem] p-8 lg:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100 relative overflow-hidden"
          >
...
<div className="group">
  ...
  <PhoneInput
    ...
    inputClass="!w-full !py-3 !px-4 !bg-slate-50 !border-b-2 !border-slate-200 focus:!border-yellow-400 !outline-none"
                ...
                className={`w-full py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-lg flex items-center justify-center gap-2
                  ${isSent 
                    ...
                    : isSubmitting
                      ...
                      : 'bg-slate-900 text-white hover:bg-yellow-400 hover:text-slate-900 hover:shadow-yellow-200 hover:-translate-y-1'
                  }
                `}
              >
                {isSubmitting ? (
