        ...
        <div className="min-h-screen flex flex-col bg-gray-900 text-white">
            ...
            <main className="flex-grow flex flex-col items-center justify-center p-8">
                <div className="max-w-4xl w-full text-center mb-16">
                    ...
                    <p className="text-xl text-gray-400">Challenge your senses and beat the high score!</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl w-full px-4 items-stretch">
                    ...
                    >
                        <div className="bg-gray-800 rounded-xl overflow-hidden shadow-lg border border-gray-700 transition-all duration-300 transform group-hover:-translate-y-2 group-hover:shadow-2xl hover:border-yellow-400 relative h-full flex flex-col">
                            ...
                            <div className="p-8 flex flex-col flex-grow">
                                ...
                                <p className="text-gray-400 mb-6 flex-grow text-base">Find the hidden drum by listening to the sound! The closer you get, the louder it becomes. Can you find it before time runs out?</p>
                    ...
                    >
                        <div className="bg-gray-800 rounded-xl overflow-hidden shadow-lg border border-gray-700 transition-all duration-300 transform group-hover:-translate-y-2 group-hover:shadow-2xl hover:border-cyan-400 relative h-full flex flex-col">
                            ...
                            <div className="p-8 flex flex-col flex-grow">
                                <h2 className="text-3xl font-bold mb-4 text-white group-hover:text-cyan-300 transition-colors">Interactive Music Lab</h2>
                                <p className="text-gray-400 mb-6 flex-grow text-base">Build drum loops, play colorful piano notes, and control BPM and volumes in real time.</p>
                                <div className="flex justify-between items-center border-t border-gray-700 pt-4 mt-auto">
