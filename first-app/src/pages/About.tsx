...
function About() {
  ...
  return (
    <div 
      className="min-h-screen bg-slate-50 font-sans text-slate-800 overflow-x-hidden selection:bg-yellow-200"
      ...
      <main>
        ...
        <section className="relative px-6 py-20 lg:py-32 overflow-hidden min-h-[90vh] flex items-center">
             ...
             <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 box-border">
                ...
                >
                    ...
                    />
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-extrabold text-slate-900 mb-6 leading-tight max-w-2xl">
                ...
                >
                     <div className="relative z-10 transform-style-3d bg-white p-4 pb-0 rounded-2xl shadow-2xl rotate-3 border border-slate-100">
                        <img 
                            src={meImage} 
                            alt="Portrait" 
                            className="w-full max-w-md mx-auto rounded-tl-xl rounded-tr-xl shadow-inner relative z-10 bg-slate-100"
                        />
        ...
        <section className="px-6 py-24 bg-slate-50">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-4xl font-serif font-bold text-slate-900">Academic Background</h2>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {education.map((item) => (
                        <div key={item.title} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg transition-all duration-300">
        ...
        <section className="py-24 px-6 bg-slate-50 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                <h2 className="text-4xl font-serif font-bold text-slate-900 mb-16 text-center">Professional Experience</h2>
                
                <div className="relative border-l-2 border-slate-200 ml-4 md:ml-0 space-y-16">
                    ...
                    {professionalExperience.map((item, index) => (
                        ...
                        >
                            <div className="md:grid md:grid-cols-12 md:gap-8 items-center">
                                ...
                                <div className="md:col-span-8 bg-white p-8 rounded-2xl shadow-sm border border-slate-100 group-hover:shadow-xl group-hover:-translate-y-1 transition-all duration-300 relative">
                                    {/* Small arrow */}
                                    <div className="hidden md:block absolute -left-2 top-1/2 -translate-y-1/2 w-4 h-4 bg-white transform rotate-45 border-l border-b border-slate-100"></div>
                                    
                                    <h3 className="text-xl font-bold text-slate-800">{item.role}</h3>
                                    <h4 className="text-slate-500 text-sm mb-4 font-serif italic">{item.company}</h4>
        ...
        <section className="px-6 py-24 bg-white relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="rounded-3xl border border-slate-200 bg-slate-950 p-8 text-white shadow-[0_20px_60px_rgba(15,23,42,0.20)]">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        {[
                            ...
                            <div key={item.title} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
