...
Alongside my technical work, I bring over 20 years of experience in music, which shapes my creative approach—helping me build digital products that are not only functional, but also engaging and expressive.
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
          {[
            ...
            <RevealOnScroll key={index}>
                <div
              className="relative group p-6 sm:p-7 lg:p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-yellow-400 hover:-translate-y-2 transition-all duration-300 ease-in-out cursor-default h-full backdrop-blur-sm"
                >
      ...
      {/* Featured Work */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
          {/* Project 1 */}
          <RevealOnScroll>
            <a href="/sequencer" className="block group cursor-pointer rounded-2xl overflow-hidden border border-white/10 transition-all duration-300 hover:shadow-2xl hover:shadow-yellow-400/10 hover:-translate-y-2 hover:border-yellow-400 bg-white/5 h-full">
                <div className="h-52 sm:h-60 lg:h-64 bg-amber-400/20 flex items-center justify-center relative overflow-hidden backdrop-blur-sm">
                    <svg className="w-24 h-24 text-yellow-200 opacity-50 transition-transform duration-500 group-hover:scale-110" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Project 2 */}
          <RevealOnScroll>
            <a href="/game" className="block group cursor-pointer rounded-2xl overflow-hidden border border-white/10 transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-400/10 hover:-translate-y-2 hover:border-indigo-400 bg-white/5 h-full">
                <div className="h-52 sm:h-60 lg:h-64 bg-indigo-500/20 flex items-center justify-center relative overflow-hidden backdrop-blur-sm">
                    <svg className="w-24 h-24 text-indigo-200 opacity-50 transition-transform duration-500 group-hover:scale-110 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
