...
const oldStr = /<div className="bg-white\/70 dark:bg-transparent p-6 sm:p-10 -mx-6 sm:mx-0 rounded-3xl backdrop-blur-md shadow-xl dark:shadow-none border border-white\/50 dark:border-transparent">/;
...
// We should also close the extra div we just added for the hover light reflection
const oldEndStr = `                    </div>
                  </div>
                </RevealOnScroll>`;
...
// Actually, the absolute div is self-closing, so we don't need to add another closing tag!

fs.writeFileSync('first-app/src/pages/Home.tsx', fileContent);
console.log('Fixed Home Hero Glassmorphism!');
